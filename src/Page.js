...
export default function Page(props) {
    ...
    return ( <
        ...
        div > Daily Discharge Volume: { discharge_obj[0] && discharge_obj[0].quantity }
        ft < sup > 3 < /sup>/s < /div> <
        /Popup> <
        /Circle> <
        Circle color = { 'blue' }
        ...
        div > Daily Discharge Volume: { discharge_obj[1] && discharge_obj[1].quantity }
        ft < sup > 3 < /sup>/s < /div> <
        /Popup> <
        /Circle> <
        Circle color = { 'blue' }
        ...
        div > Daily Discharge Volume: { discharge_obj[3] && discharge_obj[3].quantity }
        ft < sup > 3 < /sup>/s < /div> <
        /Popup> <
        /Circle> <
        Circle color = { 'blue' }
        ...
        div > Daily Discharge Volume: { discharge_obj[4] && discharge_obj[4].quantity }
        ft < sup > 3 < /sup>/s < /div> <
        /Popup> <
        /Circle> <
        Circle color = { 'blue' }
        ...
        div > Daily Discharge Volume: { discharge_obj[5] && discharge_obj[5].quantity }
        ft < sup > 3 < /sup>/s < /div> <
        /Popup> <
        /Circle> <
        Circle color = { 'blue' }
        ...
        div > Daily Discharge Volume: { discharge_obj[6] && discharge_obj[6].quantity }
        ft < sup > 3 < /sup>/s < /div> <
        /Popup> <
        /Circle> <
        Circle color = { 'blue' }
        ...
        div > Daily Discharge Volume: { discharge_obj[7] && discharge_obj[7].quantity }
        ft < sup > 3 < /sup>/s < /div> <
        /Popup> <
        /Circle> <
        Circle color = { 'blue' }
        ...
        div > Daily Discharge Volume: { discharge_obj[8] && discharge_obj[8].quantity }
        ft < sup > 3 < /sup>/s < /div> <
        /Popup> <
        /Circle> <
        Circle color = { 'blue' }
        ...
        div > Daily Discharge Volume: { discharge_obj[9] && discharge_obj[9].quantity }
        ft < sup > 3 < /sup>/s < /div> <
        /Popup> <
        /Circle> <
        Circle color = { 'blue' }
        ...
        div > Daily Discharge Volume: { discharge_obj[10] && discharge_obj[10].quantity }
        ft < sup > 3 < /sup>/s < /div> <
        /Popup> <
        /Circle> <
        Circle color = { 'blue' }
        ...
        div > Daily Discharge Volume: { discharge_obj[11] && discharge_obj[11].quantity }
        ft < sup > 3 < /sup>/s < /div> <
        /Popup> <
        /Circle> <
        Circle color = { 'blue' }
        ...
        div > Daily Discharge Volume: { discharge_obj[12] && discharge_obj[12].quantity }
        ft < sup > 3 < /sup>/s < /div> <
        /Popup> <
        /Circle> <
        Circle color = { 'blue' }
        ...
        div > Daily Discharge Volume: { discharge_obj[13] && discharge_obj[13].quantity }
        ft < sup > 3 < /sup>/s < /div> <
        /Popup> <
        /Circle> <
        Circle color = { 'blue' }
        ...
        div > Daily Discharge Volume: { discharge_obj[14] && discharge_obj[14].quantity }
        ft < sup > 3 < /sup>/s < /div> <
        /Popup> <
        /Circle> <
        Circle color = { 'blue' }
        ...
        div > Daily Discharge Volume: { discharge_obj[15] && discharge_obj[15].quantity }
        ft < sup > 3 < /sup>/s < /div> <
        /Popup> <
        /Circle> <
        Circle color = { 'blue' }
        ...
        div > Daily Discharge Volume: { discharge_obj[16] && discharge_obj[16].quantity }
        ft < sup > 3 < /sup>/s < /div> <
        /Popup> <
        /Circle> <
        /LayerGroup> <
        ...
        div > Daily Temperature Reading: { temp_obj[0] && temp_obj[0].temp } { '\u00B0' }
        C < /div> <
        a href = { add_TempURLS[2].website } > https: //waterdata.usgs.gov</a>
        <
        /Popup> <
        Circle color = { colorChange(temp_obj[0].temp) }
        center = { BRF }
        radius = { 7000 } >
        <
        Popup >
        ...
        div > < b > { temp_obj[0].name } < /b></div >
        <
        div > Daily Temperature Reading: { temp_obj[0].temp } { '\u00B0' }
        C < /div> <
        /Popup> <
        /Circle> <
        /Marker> <
        Marker position = { BRMT }
        icon = { mapMarker } >
        <
        Popup >
        <
        ...
        div > Daily Temperature Reading: { temp_obj[1] && temp_obj[1].temp } { '\u00B0' }
        C < /div> <
        a href = { add_TempURLS[3].website } > https: //waterdata.usgs.gov</a>
        <
        /Popup> <
        Circle color = { temp_obj[1] && colorChange(temp_obj[1].temp) }
        center = { BRMT }
        radius = { 7000 } >
        <
        Popup >
        ...
        div > Daily Temperature Reading: { temp_obj[2] && temp_obj[2].temp } { '\u00B0' }
        C < /div>
        ...
        <
        /Popup> <
        Circle color = { temp_obj[2] && colorChange(temp_obj[2].temp) }
        center = { FCBT }
        radius = { 7000 } >
        <
        Popup >
        ...
        div > Daily Temperature Reading: { temp_obj[3] && temp_obj[3].temp } { '\u00B0' }
        C < /div> <
        a href = { add_TempURLS[6].website } > https: //waterdata.usgs.gov</a>
        <
        /Popup> <
        Circle color = { temp_obj[3] && colorChange(temp_obj[3].temp) }
        center = { NFMT }
        radius = { 7000 } >
        <
        Popup >
        ...
        div > Daily Temperature Reading: { temp_obj[4] && temp_obj[4].temp } { '\u00B0' }
        C < /div> <
        a href = { add_TempURLS[0].website } > https: //waterdata.usgs.gov</a>
        <
        /Popup> <
        Circle color = { temp_obj[4] && colorChange(temp_obj[4].temp) }
        center = { CRVT }
        radius = { 7000 } >
        <
        Popup >
        ...
        div > Daily Temperature Reading: { temp_obj[5] && temp_obj[5].temp } { '\u00B0' }
        C < /div> <
        a href = { add_TempURLS[4].website } > https: //waterdata.usgs.gov</a>
        <
        /Popup> <
        Circle color = { temp_obj[5] && colorChange(temp_obj[5].temp) }
        center = { PRA }
        radius = { 7000 } >
        <
        Popup >
        ...
        div > Daily Temperature Reading: { temp_obj[6] && temp_obj[6].temp } { '\u00B0' }
        C < /div> <
        a href = { add_TempURLS[10].website } > https: //waterdata.usgs.gov</a>
        <
        /Popup> <
        Circle color = { temp_obj[6] && colorChange(temp_obj[6].temp) }
        center = { TRL }
        radius = { 7000 } >
        <
        Popup >
        ...
        div > Daily Temperature Reading: { temp_obj[7] && temp_obj[7].temp } { '\u00B0' }
        C < /div> <
        a href = { add_TempURLS[7].website } > https: //waterdata.usgs.gov</a>
        <
        /Popup> <
        Circle color = { temp_obj[7] && colorChange(temp_obj[7].temp) }
        center = { JCRT }
        radius = { 7000 } >
        <
        Popup >
        ...
        div > Daily Temperature Reading: { temp_obj[8] && temp_obj[8].temp } { '\u00B0' }
        C < /div> <
        a href = { add_TempURLS[10].website } > https: //waterdata.usgs.gov</a>
        <
        /Popup> <
        Circle color = { temp_obj[8] && colorChange(temp_obj[8].temp) }
        center = { CSC }
        radius = { 7000 } >
        <
        Popup >
        ...
        div > Daily Temperature Reading: { temp_obj[9] && temp_obj[9].temp } { '\u00B0' }
        C < /div> <
        a href = { add_TempURLS[8].website } > https: //waterdata.usgs.gov</a>
        <
        /Popup> <
        Circle color = { temp_obj[9] && colorChange(temp_obj[9].temp) }
        center = { JCMT }
        radius = { 7000 } >
        <
        Popup >
        ...
        div > Daily Temperature Reading: { temp_obj[10] && temp_obj[10].temp } { '\u00B0' }
        C < /div> <
        a href = { add_TempURLS[1].website } > https: //waterdata.usgs.gov</a>
        <
        /Popup> <
        Circle color = { temp_obj[10] && colorChange(temp_obj[10].temp) }
        center = { WRPT }
        radius = { 7000 } >
        <
        Popup >
        ...
        div > Daily Temperature Reading: { temp_obj[11] && temp_obj[11].temp } { '\u00B0' }
        C < /div> <
        a href = { tempSiteURLS[4].website } > https: //waterdata.usgs.gov</a>
        <
        /Popup> <
        Circle color = { temp_obj[11] && colorChange(temp_obj[11].temp) }
        center = { BCB }
        radius = { 7000 } >
        <
        Popup >
