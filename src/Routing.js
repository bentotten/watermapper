...
export default function Routing(props) {
    ...
    return ( <
        ...
        h5 > Portland Watershed < /h5><h5>Data Dashboard</h
        5 >
        <
        /Navbar.Brand> <
        /div> { /* <Navbar.Toggle /> */ }
        ...
        <
        ToggleButtonGroup className = "border border-dark"
        type = "radio"
        name = "options"
        defaultValue = { 1 } >
        <
        ToggleButton className = "chartSelect"
        value = { 1 }
        onClick = {
            () => { setDischarge(true);
                setTemperature(false); } } > Discharge Data < /ToggleButton> <
        ToggleButton className = "chartSelect"
        value = { 2 }
        onClick = {
            () => { setDischarge(false);
                setTemperature(true); } } > Temperature Data < /ToggleButton> <
        /ToggleButtonGroup> <
        div className = "chart1"
        style = {
            { display: displayDischarge ? 'block' : 'none' } } >
        <
        Route >
        <
        Chart1 / >
        ...
        style = {
            { display: displayTemperature ? 'block' : 'none' } } >
        <
        Route >
        <
        Chart2 / >
